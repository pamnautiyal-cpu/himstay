...
export default function HotelDetails() {
  ...
  const localHotels = {
    "local_01": { name: "Hotel Nagraja Palace", location: "Gangotri Hwy", description: "Luxury stay at Gangotri with traditional architecture and modern comfort.", images: ["https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600", "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Double Bed", "Attached Bath", "TV"] }, { type: "3 Bedroom Set", price: 2800, inclusions: ["Extra Bed", "TV", "Hot Water"] }] },
    "local_02": { name: "Grandparents Homestay", location: "NH 34, Matli", description: "Cozy home-like stay offering genuine pahadi hospitality and warmth.", images: ["https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800", "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600", "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Double Bed", "TV"] }] },
    "local_03": { name: "Hotel Prisha Pahal", location: "Barahat Range", description: "Best hygiene stay with scenic valley views and quiet ambiance.", images: ["https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=800", "https://images.unsplash.com/photo-1568495248636-6432b97bd949?w=600", "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Attached Bath", "Hygienic"] }, { type: "3 Bedroom Set", price: 2800, inclusions: ["Extra Space", "TV"] }] },
    "local_04": { name: "Hotel K.P Residency", location: "Near Medicose", description: "Modern comfort right in town with high-speed connectivity.", images: ["https://images.unsplash.com/photo-1568495248636-6432b97bd949?w=800", "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Modern Bed", "WiFi"] }, { type: "4 Bedroom Set", price: 3200, inclusions: ["Luxury Suite", "TV"] }] },
    "local_05": { name: "Dhruvnanda Homestay", location: "ITBP Rd", description: "Nestled in nature's lap, perfect for meditation and peaceful holidays.", images: ["https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=800", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600", "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Double Bed", "Nature View"] }] },
    "local_06": { name: "Himalayan Abode", location: "Main Market", description: "Premium market stay with easy access to local attractions.", images: ["https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800", "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600", "https://images.unsplash.com/photo-1568495248636-6432b97bd949?w=600"], rooms: [{ type: "3 Bedroom Set", price: 2800, inclusions: ["Market View", "TV"] }, { type: "4 Bedroom Set", price: 3200, inclusions: ["Premium Bed", "Attached Bath"] }] },
    "local_07": { name: "Riverside Retreat", location: "Bhagirathi Bank", description: "Stunning river view retreat by the holy Bhagirathi river stream.", images: ["https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=800", "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=600", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["River View", "TV"] }, { type: "3 Bedroom Set", price: 2800, inclusions: ["Balcony", "Hot Water"] }] },
    "local_08": { name: "Gangotri View Inn", location: "Gangori Bridge", description: "Scenic view overlooking the mountains and holy water streams.", images: ["https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600", "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Scenic View", "TV"] }, { type: "3 Bedroom Set", price: 2800, inclusions: ["Mountain View", "Attached Bath"] }] },
    "local_09": { name: "Green Valley Homestay", location: "Village Road", description: "Simple, clean stay surrounded by lush green mountain vegetation.", images: ["https://images.unsplash.com/photo-1449157291145-7efd059a4dc0?w=800", "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=600", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Double Bed"] }] },
    "local_10": { name: "Uttarkashi Guest House", location: "Old Town", description: "Authentic old town experience with traditional mountain culture.", images: ["https://images.unsplash.com/photo-1470770841072-f978cf4d019e?w=800", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600", "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Traditional Bed"] }, { type: "3 Bedroom Set", price: 2800, inclusions: ["Spacious", "TV"] }] },
    "local_11": { name: "Mountain Peak Hotel", location: "Dunda Main Rd", description: "Breathtaking peak views with crisp Himalayan morning breeze.", images: ["https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=800", "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Peak View", "TV"] }, { type: "4 Bedroom Set", price: 3200, inclusions: ["Wide View", "Attached Bath"] }] },
    "local_12": { name: "Peaceful Stay", location: "Valley View", description: "Ultra-peaceful environment away from city noise.", images: ["https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800", "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=600", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Peaceful Env"] }] },
    "local_13": { name: "Char Dham Camp", location: "Near Highway", description: "Adventurous camp-style stay equipped with comfortable bedding.", images: ["https://images.unsplash.com/photo-1559957335-5178652d87e0?w=800", "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600"], rooms: [{ type: "3 Bedroom Set", price: 2800, inclusions: ["Adventure Bed"] }, { type: "4 Bedroom Set", price: 3200, inclusions: ["Large Camp", "Attached Bath"] }] },
    "local_14": { name: "Sunrise Residency", location: "Tiloth Road", description: "Wake up to stunning sunrise views over the Garhwal ridges.", images: ["https://images.unsplash.com/photo-1496417263034-38ec4f0b655a?w=800", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600", "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Sunrise View", "TV"] }] },
    "local_15": { name: "Nature's Nest", location: "Orchard Side", description: "Tranquil retreat located right beside apple and fruit orchards.", images: ["https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800", "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=600", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600"], rooms: [{ type: "2 Bedroom Set", price: 2200, inclusions: ["Orchard View"] }, { type: "3 Bedroom Set", price: 2800, inclusions: ["Luxury Bed", "TV"] }] },
    "local_16": { name: "Skyline Hotel", location: "City Center", description: "Convenient city center location with premium hospitality.", images: ["https://images.unsplash.com/photo-1501758888041-af3ef285b470?w=800", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600", "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600"], rooms: [{ type: "3 Bedroom Set", price: 2800, inclusions: ["City View", "TV"] }, { type: "4 Bedroom Set", price: 3200, inclusions: ["Grand Bed", "Attached Bath"] }] }
  };
    ...
    if (localHotels[id]) {
      ...
      axios.get(`${BACKEND_URL}/api/hotels/${id}`)
        .then((res) => {
          ...
          setHotel({
            ...data,
            images: data.images || [data.image || "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800"],
  ...
  const mainImg = hotel.images?.[0] || "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800";
  const subImg1 = hotel.images?.[1] || "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600";
  const subImg2 = hotel.images?.[2] || "https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=600";
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#f8fafc", color: "#0f172a", minHeight: "100vh", paddingBottom: "60px" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "12px", borderRadius: "16px", overflow: "hidden", marginBottom: "30px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", height: "380px" }}>
          <div>
            <img src={mainImg} alt={hotel.name} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", height: "100%" }}>
            <img src={subImg1} alt="preview 1" style={{ width: "100%", height: "calc(50% - 6px)", objectFit: "cover" }} />
            <img src={subImg2} alt="preview 2" style={{ width: "100%", height: "calc(50% - 6px)", objectFit: "cover" }} />
          </div>
        </div>
