          ...
          {pendingHotels.length === 0 ? (
            ...
            pendingHotels.map(hotel => (
              <div key={hotel._id} style={{ border: "1px solid #cbd5e1", padding: "20px", marginBottom: "20px", borderRadius: "8px", background: "#fff" }}>
                ...
                <p style={{ margin: "5px 0", color: "#475569" }}><b>Hotel/Property Type:</b> {hotel.propertyType || hotel.listingCategory || "N/A"}</p>
                <p style={{ margin: "5px 0", color: "#475569" }}><b>Room Type:</b> {hotel.roomType || "N/A"}</p>
                <p style={{ margin: "5px 0", color: "#475569" }}><b>Description:</b> {hotel.description || "No description provided."}</p>
                <p style={{ margin: "5px 0", color: "#475569" }}><b>Owner Email:</b> {hotel.ownerEmail || hotel.email || "N/A"}</p>
                <p style={{ margin: "5px 0 15px 0", color: "#475569" }}><b>Phone No:</b> {hotel.phone || "N/A"}</p>
