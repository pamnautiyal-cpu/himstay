  ...
  return (
    <footer style={{ 
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        {/* Top Trust Banner (ORN / Modern Style) */}
        <div style={{ 
        ...
        {/* Main Grid Section (ORN Layout Style: Brand left, Columns spread right) */}
        <div style={{ 
          display: "grid", 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            {/* Social Media Icons (ORN Style) */}
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              {/* LinkedIn */}
              <a href="#linkedin" style={socialIconStyle}>
              ...
              {/* Instagram */}
              <a href="#instagram" style={socialIconStyle}>
              ...
              {/* YouTube */}
              <a href="#youtube" style={socialIconStyle}>
              ...
              {/* Facebook */}
              <a href="#facebook" style={socialIconStyle}>
              ...
              {/* X / Twitter */}
              <a href="#twitter" style={socialIconStyle}>
              ...
              {/* Pinterest */}
              <a href="#pinterest" style={socialIconStyle}>
...
const columnTitleStyle = { 
  fontSize: "12px", 
  fontWeight: "750", 
  color: "#ef4444", // ORN Style Red Headings for Columns
  margin: "0 0 16px 0",
