        ...
        <div style={{ 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              ...
              {/* 🟢 WhatsApp Quick Chat Button (Newly Added) */}
              <a href="https://wa.me/919410106470?text=Hello,%20I%20want%20to%20know%20about%20hotel%20bookings." 
                 target="_blank" 
                 rel="noopener noreferrer" 
                 style={{ ...socialIconStyle, background: "#22c55e", borderColor: "#16a34a" }} 
              ...
              <div style={nonClickableIconStyle} title="LinkedIn (Inactive)">
              ...
              {/* YouTube (Active with provided link) */}
              <a href="https://youtube.com/@thehimalayans?si=IeiKNkqtgrTpEQDA" target="_blank" rel="noopener noreferrer" style={socialIconStyle} title="YouTube">
              ...
              {/* Facebook (Active with provided share link) */}
              ...
              <div style={nonClickableIconStyle} title="X (Twitter) (Inactive)">
              ...
              {/* Pinterest (Non-clickable) */}
              <div style={nonClickableIconStyle} title="Pinterest (Inactive)">
          ...
          <div>
            ...
            <ul style={ulStyle}>
              ...
              <li><Link to="/char-dham-agents" style={linkStyle}>Char Dham Agent Booking</Link></li>
